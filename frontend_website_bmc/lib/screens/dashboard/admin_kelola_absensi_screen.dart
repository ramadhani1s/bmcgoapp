...
import '../../widgets/admin_sidebar_shell.dart';
...
class _AdminKelolaAbsensiScreenState extends State<AdminKelolaAbsensiScreen> {
  ...
  void _onSidebarMenuTap(String title) {
    ...
    if (title == 'Verifikasi Pendaftaran') {
      Navigator.pushReplacementNamed(
        context,
        AppRoutes.adminDashboard,
        arguments: 'Verifikasi Pendaftaran',
      );
      return;
    }
    if (title == 'Kelola Mentor') {
      Navigator.pushReplacementNamed(
        context,
        AppRoutes.adminDashboard,
        arguments: 'Kelola Mentor',
      );
      return;
    }
    if (title == 'Kelola Jadwal') {
      Navigator.pushReplacementNamed(
        context,
        AppRoutes.adminDashboard,
        arguments: 'Kelola Jadwal',
      );
      return;
    }
    if (title == 'Kelola Absensi') {
      return;
    }
    if (title == 'Kelola Pengumuman') {
      Navigator.pushReplacementNamed(
        context,
        AppRoutes.adminDashboard,
        arguments: 'Kelola Pengumuman',
      );
      return;
    }
    if (title == 'Kelola Paket Les') {
      Navigator.pushReplacementNamed(
        context,
        AppRoutes.adminDashboard,
        arguments: 'Kelola Paket Les',
      );
      return;
    }
    if (title == 'Kelola Profil Alumni') {
      Navigator.pushReplacementNamed(
        context,
        AppRoutes.adminDashboard,
        arguments: 'Kelola Profil Alumni',
      );
    }
  }
